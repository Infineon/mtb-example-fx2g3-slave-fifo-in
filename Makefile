...
APPNAME=mtb-example-fx2g3-slave-fifo-in
...
DEFINES=CYUSB4014_BZXI=1 BCLK__BUS_CLK__HZ=75000000 DEBUG_INFRA_EN=1 FREERTOS_ENABLE=1 USBFS_LOGS_ENABLE=1 BUS_WIDTH_16=1 INTERLEAVE_EN=0 DEVICE1_EN=0 
