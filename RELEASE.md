# EZ-USB&trade; FX2G3: LVCMOS Slave FIFO IN application 1.0.2
...
Version 1.0.2: Added support for Cortex M0+ and enabled CLKOUT
...
* [EZ-USB&trade; FX2G3: LVCMOS Slave FIFO IN application README.md](./README.md)
